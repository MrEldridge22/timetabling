...
faculty_subjects_dict = {   'English':            
                            ...
                            'RP':           
                                        ['12 Research Project A (Yr 11s)',
                                            ...
                                            '12 Research Project A (Modified)'],
                            ...
                            'Arts':
                                        ['07 Dance',
                                            ...
                                            '10 Drama A',
                                            '10 Drama B',
                                            '10 Media Arts A - Film & Cinematography',
                                            '10 Media Arts B - Animation',
                                            '10 Music A',
                                            '10 Music B',
                                            '10 Visual Arts A',
                                            '10 Visual Arts B',
...
faculty_subjects_df = pd.DataFrame.from_dict(faculty_subjects_dict, orient='index').T
# print(faculty_subjects_df)
...
lines_df.drop(['Code', 'LineTagID', 'LineNo', 'Classes'], inplace=True, axis=1)
