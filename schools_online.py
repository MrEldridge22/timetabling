...
# 8 Credits 10 or 20
# 9 Enrolment Number False If this is not set, a new enrolment is assumed. (Not Essential)
# 10 Results Due J (June) or D (December)
# 11 Program Variant A to Z (Not Essential)
...
# 15 Enrolment Status True C (Completed), D or X (Deleted), P (Proposed), E or F (Enrolled), or W (Withdrawn). Must be in upper case. (What's the default??)
